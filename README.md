...
I learned
- how to install MVT on Debian Linux using Python's pipx package manager
- how to install ADB to allow MVT to scan my mobile device
- how to verify successful installation of MVT
